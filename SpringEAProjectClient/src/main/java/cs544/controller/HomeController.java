...
public class HomeController {
	...
	public String populate(){
		userRestClient.createUser(new User("rick", "123", "mama", "lala", "rick@gmail.com", new Address("1000 N 4th ST", "Fairfield", "Iowa", "US", "52557")));
		productRestClient.createProduct(new Product("Teletub", "It is one of the best character in the whole wide would", 30.0, 33, 2));
		productRestClient.createProduct(new Product("Rise of them", "It is one of the super annoying Ebook in the whole wide would", 15.0, 31, 5));
		return "index";
	}
